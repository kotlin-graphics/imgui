...
class TabBar {
    ...
    infix fun getTabOrder(tab: TabItem) = tabs.indexOf(tab)
//    infix fun getTabName(tab: TabItem): String {
//        assert(tab.nameOffset != -1 && tab.nameOffset < tabsNames.size)
//        return tabsNames[tab.nameOffset]
//    }
