...
class Context(sharedFontAtlas: FontAtlas? = null) {
    ...
    var currentItemFlags: ItemFlags = none
    ...
    var debugLogFlags: DebugLogFlags = none//DebugLogFlag.OutputToTTY or DebugLogFlag.EventMask wo DebugLogFlag.EventClipper
