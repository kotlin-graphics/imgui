...
//	val lwjglGlfw1: ImplGlfw
//	val lwjglGlfw2: ImplGlfw
//	val ctx1: Context
//	val ctx2: Context
//
//	var f = 0f
...
//		lwjglGlfw1 = ImplGlfw(window1, true, GlfwClientApi.OpenGL)
//		lwjglGlfw2 = ImplGlfw(window2, true, GlfwClientApi.OpenGL)
//
...
//	}
//
//	fun render(stack: MemoryStack, window: GlfwWindow, implGlfw: ImplGlfw, ctx: Context) {
//
//		ctx.setCurrent()
//
...
//
//		implGlfw.renderDrawData(ImGui.drawData!!)
//
//		if (DEBUG)
//			checkError("mainLoop")
//	}
