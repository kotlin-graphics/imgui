...
//        // Backup GL state
//        val lastProgram = run {
//            glGetIntegerv(GL_CURRENT_PROGRAM, buf.asIntBuffer())
//            buf.getInt(0)
//        }
//        val lastTexture = run {
//            glGetIntegerv(GL_TEXTURE_BINDING_2D, buf.asIntBuffer())
//            buf.getInt(0)
//        }
//        val lastArrayBuffer = run {
//            glGetIntegerv(GL_ARRAY_BUFFER_BINDING, buf.asIntBuffer())
//            buf.getInt(0)
//        }
//        val lastVertexArray = run {
//            glGetIntegerv(GL_VERTEX_ARRAY_BINDING, buf.asIntBuffer())
//            buf.getInt(0)
//        }
//
//        program = ProgramA(gl, "shader")
//
//        glGenBuffers(bufferName.capacity(), bufferName)
//
...
//        glBindVertexArray(0)
//
//        if (glGetError() != GL.GL_NO_ERROR) throw Error("createDeviceObject")
//
