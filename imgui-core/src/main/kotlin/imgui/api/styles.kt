...
interface styles {
    ...
    fun styleColorsDark(dst: Style? = null) {
        (dst ?: g.style).apply {
            ...
            colors[Col.DockingPreview]          (colors[Col.HeaderActive] * Vec4(1.0f, 1.0f, 1.0f, 0.7f))
            colors[Col.DockingEmptyBg]          (0.20f, 0.20f, 0.20f, 1.00f)
    ...
    fun styleColorsLight(dst: Style? = null) {
        (dst ?: g.style).apply {
            ...
            colors[Col.TabUnfocused]            (colors[Col.Tab].lerp(colors[Col.TitleBg], 0.80f))
            colors[Col.TabUnfocusedActive]      (colors[Col.TabActive].lerp(colors[Col.TitleBg], 0.40f))
            colors[Col.DockingPreview]          (colors[Col.Header] * Vec4(1.0f, 1.0f, 1.0f, 0.7f))
            colors[Col.DockingEmptyBg]          (0.20f, 0.20f, 0.20f, 1.00f)
